...
public class CustomerTest extends UnitilsJUnit4 {
  ...
  public void testDeleteContact() {
    ...
    Assert.assertEquals(2, customer.getContacts().size());// is2 coz one standard contact is always
    Assert.assertEquals(contact2.getEmail(), customer.getContacts().get(1).getEmail());
  }
